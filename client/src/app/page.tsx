...
const circles: Circle[] = [
  {
    id: 1,
    name: "東京大学テニスサークル",
    description: "週2回のコートでの練習と月1回の大会参加。初心者から上級者まで楽しく活動しています。年間を通して合宿やイベントも開催。",
    type: "university"
  },
  {
    id: 2,
    name: "社会人フットサルクラブ TOKYO FC",
    description: "平日夜と土日にフットサルを楽しむ社会人サークル。チームワークを大切にしながら、健康維持と交流を目的に活動中。",
    type: "professional"
  },
  {
    id: 3,
    name: "早稲田大学写真研究会",
    description: "街歩き撮影会や展示会の開催を通じて写真技術を磨く大学サークル。デジタル・フィルム問わず、様々な写真表現を学べます。",
    type: "university"
  },
  {
    id: 4,
    name: "渋谷読書会",
    description: "月2回、カフェで本について語り合う社会人の読書サークル。ジャンルは問わず、新しい本との出会いと知的な交流を楽しんでいます。",
    type: "professional"
  },
  {
    id: 5,
    name: "慶應大学軽音楽サークル",
    description: "バンド活動を中心とした音楽サークル。定期ライブやコンテストへの参加を通じて、音楽スキルの向上と仲間との絆を深めています。",
    type: "university"
  },
  {
    id: 6,
    name: "Tokyo Hiking Club",
    description: "関東近郊の山々をハイキングする社会人サークル。自然を楽しみながら健康づくりと仲間作りを目指しています。初心者歓迎。",
    type: "professional"
  }
];
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <header className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Circle Connect</h1>
          <p className="text-lg text-gray-600">サークルとつながろう</p>
        </header>
                ...
                <div className="flex justify-between items-start mb-4">
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      <h2 className="text-xl font-semibold text-gray-900">{circle.name}</h2>
