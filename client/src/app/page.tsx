...
export default function Home() {
  ...
  const handleJoinCircle = (circle_name:string) => {
    alert(`サークル： ${circle_name} に参加申請しました！`);
  };
            ...
            {circleList.map((circle) => (
              ...
              >
                <div className="flex justify-between items-start mb-4">
                  <img
                    src={`/icons/circle${circle.circle_id % 6 + 1}.png`}
                ...
                <div className="flex gap-3 flex-wrap">
                  <button
                    ...
                    onClick={() => handleJoinCircle(circle.circle_name)}
                  >
                    参加申請
                  </button>
